    ...
    try:
        while True:
            ...
            if mode == "logenesis":
                ...
                # Extract Memory Metadata from client
                memory_index = user_input.get("memory_index", None)
                recalled_context = user_input.get("recalled_context", None)

                response = logenesis_engine.process(
                    text,
